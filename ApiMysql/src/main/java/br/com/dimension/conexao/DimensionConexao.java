...
public class DimensionConexao {
        private static final String url = "jdbc:sqlserver://projetosem1.database.windows.net:1433;database=BancoScript;user=Felipe@projetosem1;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;";
        private static final String username = "Felipe";
        private static final String password = "goiabada123*";
